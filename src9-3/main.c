...
int main(int argc, char** argv) {
  ...
  SDL_Window* window = SDL_CreateWindow("TotalCH8", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, CH8_DISPLAY_W * SCALE, CH8_DISPLAY_H * SCALE, SDL_WINDOW_SHOWN);
